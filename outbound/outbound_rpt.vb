...
Public Class outbound_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InventorySample.outbound_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedoutbound_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outbound_rpt = New outbound_rpt
        rpt.Site = Me.Site
        Return rpt
    End Function
